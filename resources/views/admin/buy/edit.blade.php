...
<h4 class="mt-4"> Edit Order</h4>


<form action="{{ route('customer.buy.update', $buy->id) }}" method="post" class="mt-4 col-lg-6">
    @csrf
    ...
    <div class="form-floating mb-3">
        <input type="number" class="form-control" name="qty" id="qty" placeholder="Qty" value="{{ old('qty', $buy->qty) }}>
